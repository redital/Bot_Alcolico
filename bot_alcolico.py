...
N.B. Questo bot è hostato su un server gratuito, può capitare che venga staccato per dare priorità a chi paga. Se usando questo bot dovessi vedere che non risponde, contatta @AculeoCrepuscolare
""" , reply_markup=markup )
